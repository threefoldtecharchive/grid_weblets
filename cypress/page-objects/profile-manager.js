class ProfileManager {
  get getProfileManagerBtn() {
    return cy.get("tf-profiles").shadow().find(".profile-menu");
  }

  get getCreateProfileBtn() {
    return cy.get("tf-profiles").shadow().find(".tabs").contains("Create Profile Manager");
  }

  get getProfilePasswordField() {
    return cy.get("tf-profiles").shadow().find(".input");
  }

  get getCreateNewProfileManagerBtn() {
    return cy.get("tf-profiles").shadow().find(".button");
  }

  get getProfileNameField() {
    return cy.get("tf-profiles").shadow().find(".input[placeholder='Profile Name']").clear({ force: true });
  }

  get getMnemonicsField() {
    return cy.get("tf-profiles").shadow().find("input[placeholder='Enter Your Mnemonics']");
  }
  ...
  get getActivateProfileButton() {
    return cy.get("tf-profiles").shadow().find("button[class='button']");
  }
