...
In the new issue you have to mention the following: - Release link
you can find it by changing the branch to the needed tag and then copy the URL. - Charts directory link
